...
def _build_ai_system_prompt(user):
    ...
    return {
        ...
        'content': (
            ...
            '13. For addable plans, use this exact planner_payload format at the very end. ONLY include the sections you are creating (e.g., if only exercises, omit nutrition_plan; if only meals, omit workout_plan):\n'
            '<planner_payload>\n'
            ...
            '</planner_payload>\n'
            '14. Only include <planner_payload> when a concrete addable plan is present. Never include markdown code fences around it. Omit null/empty sections from the JSON.\n'
            'App context:\n'
